...
import { Eye, EyeOff, Trophy, Star, Crown, Sparkles, UserPlus } from 'lucide-react';
...
export default function RegisterPage() {
  const { register, accessToken, isLoading } = useAuth();
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-lg text-background/70 max-w-md leading-relaxed">
                Créez votre compte et commencez à partager vos classements avec des milliers d'utilisateurs.
              </p>
            </div>
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground">
              Inscrivez-vous pour créer vos propres tier lists
            </p>
          </div>
